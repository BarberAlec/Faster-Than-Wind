...
class Background{
    ...
    refresh(tiled_background = false, background_image = false) {
...
myBackground = new Background(tiled_background=true, background_image=img_tiles[0]);